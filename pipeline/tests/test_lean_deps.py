...
def test_short_name():
    assert _short_name("ScientificMemory.Chemistry.Adsorption.Langmuir1918.langmuir_sub_one") == "langmuir_sub_one"
...
def test_find_referenced_declarations():
    ...
    refs2 = _find_referenced_declarations(" LangmuirCoverage K P", {"LangmuirCoverage", "langmuir_isotherm"})
...
def test_extract_dependency_ids_for_cards_populates_deps(tmp_path):
    ...
    repo = tmp_path
    lean_file = repo / "formal" / "ScientificMemory" / "Chemistry" / "Adsorption" / "Langmuir1918.lean"
...
""", encoding="utf-8")
    cards = [
        {"id": "card_001", "lean_decl": "Sm.Langmuir1918.langmuir_sub_one", "file_path": "formal/ScientificMemory/Chemistry/Adsorption/Langmuir1918.lean"},
        {"id": "card_002", "lean_decl": "Sm.Langmuir1918.langmuir_recip_denom", "file_path": "formal/ScientificMemory/Chemistry/Adsorption/Langmuir1918.lean"},
    ]
...
def test_extract_dependency_ids_for_cards_missing_file(tmp_path):
    ...
    cards = [
        {"id": "c1", "lean_decl": "X.foo", "file_path": "formal/Nonexistent.lean", "dependency_ids": []},
    ]
